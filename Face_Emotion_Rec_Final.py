...
def getAllEncodingsFromS3():
    ...
    for key in list:
        s3Client.download_file('face-rec-final-enc', key['Key'], 'data/'+key['Key'])
...
def localEmotionRecognition(img):
    ...
    for (x, y, w, h) in faces:
        ...
        if max(all_emotions_numbers) > 85:
...
# emotion recognition with AWS Rekognition
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        matches = face_recognition.compare_faces(
            known_people_encodings, face_encoding)
